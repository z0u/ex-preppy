...
- [2.5.1](docs/m2-control/ex-2.5.1-redux.ipynb): Re-run of [2.5](docs/m2-control/ex-2.5-only-red.ipynb), in which we intervene on _red_ without the color wheel.
- [2.7.1](docs/m2-control/ex-2.7.1-redux.ipynb): Re-run of [2.7](docs/m2-control/ex-2.7-delete-hue.ipynb), in which we induce a color wheel without anchoring _red_, and ablate _hue_ (rather than any particular hue).
