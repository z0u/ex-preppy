...
def create_train_step(  # noqa: C901
    model: ColorMLP,
    ...
    def train_step(engine: Engine, batch: tuple[Tensor, dict[str, Tensor]]) -> dict[str, Any]:  # noqa: C901
        model.train()
...
def train_color_model_ignite(  # noqa: C901
    model: ColorMLP,
